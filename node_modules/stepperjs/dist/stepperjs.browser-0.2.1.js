    ...
    Stepper.prototype.start = function start() {
        ...
        var stepping = function stepping(timestamp) {
            ...
            if (pastTime >= duration) {
                ...
                (_emitter4 = _this.emitter).emit.apply(_emitter4, ['update'].concat(blend(1)));
                ...
                if (_this.loop) {
                    ...
                    if (_this.onceUpdate.length > 0) {
                        for (var i = 0, n = _this.onceUpdate.length; i < n; i++) {
                            _this.off.apply(_this, _this.onceUpdate.pop());
                        }
                    }
                    return;
                }
                ...
                (_emitter5 = _this.emitter).emit.apply(_emitter5, ['update'].concat(blend(progress)));
            }
...
//# sourceMappingURL=stepperjs.browser-0.2.1.js.map