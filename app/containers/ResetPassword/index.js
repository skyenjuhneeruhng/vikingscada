...
import ForgotPasswordForm from './emailForm';
import ResetPasswordForm from './resetPassForm';
import Slider from './../../components/Slider';

import { requestEmail, sendResetPassword } from './actions';
...
class ForgotPassword extends React.Component {
  constructor(props) {
    ...
    this.state = {
      code: (props.location && props.location.pathname && props.location.pathname.split('/')[2]) || ''
    };
  }
  ...
  onSubmitReset = (data) => {
    ...
    this.props.sendResetPassword({ ...data, code });
  }
  ...
  render() {
    return (
      <div className="m-grid m-grid--hor m-grid--root m-page sign-in">
            ...
            <div className="m-stack m-stack--hor m-stack--desktop">
                  ...
                  <div className="m-login__forget-password" style={{ display: 'block' }}>
                    <div className="m-login__head">
                      <h3 className="m-login__title">
                        {!this.state.code ? 'Forgot password?' : 'Change password'}
                      </h3>
                      <div className="m-login__desc">
                        {!this.state.code ? 'Enter your email to reset your password' : 'Enter your new password'}
                      </div>
                    </div>
                    {this.state.code ? (
                      <ResetPasswordForm
              ...
              <div className="m-stack__item m-stack__item--center">
                <div className="m-login__account">
                  ...
                  &nbsp;&nbsp;
                  <Link to="/login" id="m_login_signup" className="m-link m-link--focus m-login__account-link">
                    Log In
                  </Link>
                </div>
              </div>
...
export default connect(null, {
  push, requestEmail, sendResetPassword
})(ForgotPassword);
